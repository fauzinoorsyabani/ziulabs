...
<body>
<header class="site-header"><a class="brand" href="#top" aria-label="ZiuLabs home"><span class="brand-mark">Z</span><span>Ziu<span class="brand-accent">Labs</span></span></a><button class="nav-toggle" type="button" aria-expanded="false" aria-controls="primary-navigation" aria-label="Buka menu navigasi"><span class="nav-toggle-icon" aria-hidden="true"><i></i><i></i><i></i></span></button><nav class="nav" id="primary-navigation" aria-label="Navigasi utama"><a href="#catalog">Katalog</a><a href="#how-it-works">Cara kerja</a><a href="#faq">FAQ</a></nav><a class="header-cta" href="<?= e($app['support_url']) ?>" target="_blank" rel="noopener">Chat support <span>↗</span></a></header>
<main id="top">
